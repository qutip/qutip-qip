...
class _EvoElement():
    ...
    refer to :class:`qutip_qip.Pulse`.
    """
...
class Pulse():
    ...
    Attributes
    ----------
    ideal_pulse: :class:`qutip_qip.pulse._EvoElement`
        The ideal dynamic of the control pulse.
    coherent_noise: list of :class:`qutip_qip.pulse._EvoElement`
    ...
    lindblad_noise: list of :class:`qutip_qip.pulse._EvoElement`
    ...
    def add_coherent_noise(self, qobj, targets, tlist=None, coeff=None):
        ...
        tlist: array-like, optional
            ...
            length
            or one element shorter compared to `coeff`. See documentation for
            the parameter `spline_kind` of :class:`qutip_qip.Pulse`.
        coeff: array-like or bool, optional
