...
PACKAGES = ['qip', 'qip/device', 'qip/operations', 'qip/compiler',
            'qip/algorithms']
PACKAGE_DATA = {}
...
def write_version_py(filename='qip/version.py'):
    cnt = """\
...
print(local_path)
sys.path.insert(0, os.path.join(local_path, 'qip'))  # to retrive _version
print(local_path)


# always rewrite _version
if os.path.exists('qip/version.py'):
    os.remove('qip/version.py')
